...
subroutine read_database(data_file, experiments)
    ...
    type(nn_experiment), intent(out), allocatable, dimension(:) :: experiments
...
subroutine write_database(pp_data, np_data, file_name)
    implicit none
    type(nn_experiment), intent(in), dimension(:) :: pp_data
    type(nn_experiment), intent(in), dimension(:) :: np_data
...
subroutine trim_database(cut_off, array)
    implicit none
    integer, intent(in) :: cut_off
    type(nn_experiment), intent(inout), allocatable, dimension(:) :: array
